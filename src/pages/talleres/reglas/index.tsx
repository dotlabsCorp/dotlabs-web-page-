    ...
    <Layout headTitle="Talleres">
      ...
      <div>
        <p>
          ...
          inclusivo para todos los participantes de nuestros talleres y eventos,
          hemos establecido las siguientes reglas y normas:
        </p>
        ...
        <ol>
          ...
          <li>No se tolerará la violencia o la intención de provocar caos.</li>
        </ol>
        ...
        <ol>
          <li>
            Durante las charlas y presentaciones, se debe evitar interrupciones
            a menos que sea para hacer preguntas.
          </li>
          <li>
            No se permitirá levantarse a tomar bebidas u otros motivos que
            puedan generar distracciones o interrupciones.
          </li>
          <li>
          ...
          <li>
            ...
            inapropiado, ya que este tipo de lenguaje puede generar un ambiente
            hostil y poco respetuoso.
          </li>
          <li>
            Todos los participantes deben respetar al presentador y centrarse en
            el tema de la charla o presentación, evitando hablar de otros temas
            o actividades que puedan distraer o incomodar a los demás.
          </li>
        </ol>
